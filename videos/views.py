    ...
    def post(self, request, pk):
        ...
        try:
            ...
            RecipeResult.objects.create(
                ...
                detected_language=result_data.get('detected_language', 'English'),
                country_of_origin=result_data.get('country_of_origin', 'Unknown'),
                ingredients=json.dumps(result_data['ingredients']),
                steps=json.dumps(result_data['steps']),
                cooking_time=result_data.get('cooking_time', 'Unknown'),
                tools_used=json.dumps(result_data.get('tools_used', [])),
